...
public class GameMenu extends Application {
    ...
    protected static class Position {
        public static record RectPos(double posX, double posY, double posX2, double posY2) {
            ...
            public double w() {
                return (posX2 - posX) * WIDTH;
            }

            public double h() {
                return (posY2 - posY) * HEIGHT;
            }
    ...
    public Object addCardListener(Callback cb) {
        cardListeners.add(cb);
        return cb;
    }

    public Object addButtonListener(Callback cb) {
        buttonListeners.add(cb);
        return cb;
    }

    public Object addRowListener(Callback cb) {
        rowListeners.add(cb);
        return cb;
    }

    public Object addBgListener(Callback cb) {
        bgListeners.add(cb);
        return cb;
    }
